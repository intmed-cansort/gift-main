...
However, we also acknowledge that many more recent articles about presenting results of factorial trials do suggest that the interaction analysis should be included even when there is inadequate sample size and the interaction is not anticipated.  This recommendation occurs even when some of the authors acknowledge the exaggeration errors discussed above.  The rationale seems to be that it is more transparent, allows readers to make their own decisions and that appropriate cautions about over-interpretation can be given along side the interaction analysis. 
